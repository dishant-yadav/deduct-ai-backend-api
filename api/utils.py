...
def extractImages(input_path, output_path="video_frames"):
...
def get_objects_from_image(image_path, treshold_value=0.5):
    ...
    for index in range(len(predictions[0])):
        ...
        if confidence_score > treshold_value:
...
# print(get_objects_from_video("./../media/cases/videos_recs/SIGNUPPAGE_fEi6D4h.webm"))
